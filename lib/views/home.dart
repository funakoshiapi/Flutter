            ...
            child: Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text(
                    "Enter Ingredients you have and I will choose the best recipes for you",
                    style: TextStyle(
                        fontSize: 15,
                        color: Colors.white,
                        ...
                        InkWell(
                            onTap: () async {
                              if (textEditingController.text.isNotEmpty) {
                                ...
                                recipies = new List();
                                String url =
                                    "https://api.edamam.com/search?q=${textEditingController.text}&app_id=35049370&app_key=792c57e9567e76464ac29df0c708770b";
